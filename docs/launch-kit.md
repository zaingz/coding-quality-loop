...
> - 124 offline eval cases across 9 suites pin the gates so they don't drift.
...
dependencies. 124 offline eval cases across 9 suites, re-run on every push.
...
> executable gates that reject "looks right to me" instead of taking its word. 124
