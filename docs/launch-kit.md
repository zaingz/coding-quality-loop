...
> - 130 offline gate cases across 6 suites pin the gates so they don't drift (plus a 10-case trigger smoke fixture).
...
dependencies. 130 offline gate cases across 6 suites, re-run on every push.
...
> executable gates that reject "looks right to me" instead of taking its word. 130
