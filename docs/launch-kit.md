...
> - 216 offline gate cases across 6 core suites pin the gates so they don't drift (plus 35 add-on cases for the opt-in control plane and a 10-case trigger smoke fixture).
...
dependencies. 216 offline gate cases across 6 core suites, re-run on every push.
