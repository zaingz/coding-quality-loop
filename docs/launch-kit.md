...
> - 234 offline gate cases across 6 core suites pin the gates so they don't drift (plus 35 add-on cases for the opt-in control plane).
...
dependencies. 234 offline gate cases across 6 core suites, re-run on every push.
...
> executable gates that reject "looks right to me" instead of taking its word. 234
